...
export const fetchProformas = async (): Promise<{
  ...
  try {
    const res = await axios.get<Proforma[]>("/data/budget-form/all");
      ...
      proformas: [
        {
          ...
          fechaAprobacion: new Date("2023-01-02"),
          fechaEntrega: new Date("2023-01-10"),
          nroFactura: "F001",
          estado: "Aceptado",
          ...
          creadoPor: "Usuario 1",
          fechaActualizado: new Date("2023-01-05"),
          actualizadoPor: "Usuario 2",
          fechaTermino: new Date("2023-01-15"),
        ...
        },
        {
          ...
          fechaAprobacion: new Date("2023-02-02"),
          fechaEntrega: new Date("2023-02-10"),
          nroFactura: "F002",
          estado: "En curso",
          observacion: "Observación de la proforma 2",
          tipoOrden: "Tipo 2",
          status: false,
          creado: new Date("2023-02-01"),
          creadoPor: "Usuario 2",
          fechaActualizado: new Date("2023-02-05"),
          actualizadoPor: "Usuario 3",
          fechaTermino: new Date("2023-02-15"),
        ...
        },
        {
          ...
          fechaAprobacion: new Date("2023-03-02"),
          fechaEntrega: new Date("2023-03-10"),
          nroFactura: "F003",
          estado: "Anulado",
          observacion: "Observación de la proforma 3",
          tipoOrden: "Tipo 3",
          status: true,
          creado: new Date("2023-03-01"),
          creadoPor: "Usuario 3",
          fechaActualizado: new Date("2023-03-05"),
          actualizadoPor: "Usuario 4",
          fechaTermino: new Date("2023-03-15"),
